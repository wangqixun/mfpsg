...
model = dict(
    ...
    relationship_head=dict(
        ...
        cache_dir='/share/wangqixun/workspace/bs/psg/mfpsg/output/tmp',
...
load_from = '/share/wangqixun/workspace/github_project/mmdetection_checkpoint/model_dl/mask2former_r50_lsj_8x2_50e_coco-panoptic_20220326_224516-11a44721.pth'
resume_from = None
work_dir = '/share/wangqixun/workspace/bs/psg/mfpsg/output/v0'
