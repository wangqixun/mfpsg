    ...
    panoptic_head=dict(
        ...
        pixel_decoder=dict(
            ...
            positional_encoding=dict(
                type='LearnedPositionalEncoding', num_feats=128, row_num_embed=1,
                 col_num_embed=256, normalize=True),
            init_cfg=None),
...
resume_from = None
work_dir = '/root/autodl-tmp/output/swin-base-focal-loss-feature-merge'