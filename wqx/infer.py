...
if __name__ == '__main__':
    ...
    # ==== start ========================================================================================
    submit_output_dir = '/share/wangqixun/workspace/bs/psg/OpenPSG/submit/swintiny_1333'  # submit 输出地址
    psg_test_data_file = '/share/data/psg/dataset/for_participants/psg.json'
    img_dir = '/share/data/psg/dataset'  # 图像地址

    config_file = '/share/wangqixun/workspace/bs/psg/mfpsg/configs/psg/swintiny-slurm.py'  # 训练时候用的config
    checkpoint_file = '/share/wangqixun/workspace/bs/psg/mfpsg/output/swintiny/epoch_12.pth'  # 训练得到的权重。默认的地址是我们训练出来的权重
    pretrained_transformers = '/share/wangqixun/workspace/bs/tx_mm/code/model_dl/hfl/chinese-roberta-wwm-ext'  # 训练时用的 pretrained_transformers
    # ==== end ==========================================================================================
    get_val_p(
